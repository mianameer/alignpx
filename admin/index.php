...
if (isset($_POST['submit'])) {
    ...
    if (empty($error)) {
        ...
        if (mysqli_num_rows($emailExistResponse) > 0) {
            ...
            $updateUserOtp = "UPDATE `users` SET `otp`='$otp' WHERE `email`='$email'";
            mysqli_query($connection_string, $updateUserOtp);
            $_SESSION['userEmail'] = $getUserInfo->email;
            $_SESSION['userId'] = $getUserInfo->id;
                        ...
                        <form action="" method="POST" class="text-left">
                            <div class="form">
                                <div id="email-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="email" value="<?= $email ?>" class="form-control" placeholder="Email">
                                </div>
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <input id="password" name="password" value="<?= $password?>" type="password" class="form-control" placeholder="Password">
